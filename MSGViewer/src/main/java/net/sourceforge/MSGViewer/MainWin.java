...
public class MainWin extends BaseDialog implements MainDialog, OpenNewMailInterface, LoadMessageInterface {
    ...
    public String getUniqueDialogIdentifier(Object requester) {
        /*
         * This way the title of the dialog won't change the id, of the dialog. The id
         * of the dialog is used for saveing with height and position of the dialog
         */
        if (dialog_id == null)
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(layout.createSequentialGroup().addComponent(viewerPanel, javax.swing.GroupLayout.DEFAULT_SIZE,
