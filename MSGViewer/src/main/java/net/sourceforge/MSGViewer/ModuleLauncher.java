...
public class ModuleLauncher extends BaseModuleLauncher {
    ...
    public void invokeGui() {
        if (splashEnabled()) {
            splash = new StartupWindow("/at/redeye/FrameWork/base/resources/pictures/redeye.png");
        }
        ...
        for (String arg : args) {
            if (arg.toLowerCase().endsWith(".msg") || arg.toLowerCase().endsWith(".mbox")
                ...
                MainDialog win = getStartupFlag(CLIHelpMSGViewer.CLI_MAINWIN) ? new MainWin(root, arg)
